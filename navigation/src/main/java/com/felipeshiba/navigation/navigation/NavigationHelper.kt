...
typealias ActionResolverMap = @JvmSuppressWildcards Map<Class<out ActionKey>, ActionResolver<*>>

open class Navigator(
    private val actionResolver: ActionResolverMap
) {
    open fun createFragment(key: ActionKey): Fragment {
        val resolver = actionResolver[key::class.java] as ActionResolver<ActionKey>?
